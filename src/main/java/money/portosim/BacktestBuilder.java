...
public class BacktestBuilder {
    ...
    public BacktestBuilder(SeriesQuote prices) {
        setPrices(prices);
    }
    ...
    public Result run(SeriesQuote prices) {
        setPrices(prices);
        return run();
    }
    ...
    public BacktestBuilder setPrices(SeriesQuote prices) {
        this.prices = prices;
        return this;
    }
